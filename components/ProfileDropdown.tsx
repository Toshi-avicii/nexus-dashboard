            ...
            <DropdownMenuTrigger>
                {
                    profile.dp ? <Image src={profile.dp} alt={profile.username} className='w-4 h-4 rounded-full' /> :
                        <div className='rounded-full flex justify-center items-center'>
                            <div
                                className='shadow-neutral-200 shadow-md bg-blue-100 p-2 cursor-pointer uppercase font-bold text-sm font-quickSand tracking-wide text-blue-700 rounded-full'
                            >
